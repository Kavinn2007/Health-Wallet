...
BEGIN
    ...
    -- Validate at least one organ/tissue is selected
    ...
    -- Insert or reactivate donor profile
    ...
    -- Insert or update organ donation preferences
    ...
    -- Create immutable consent history record
...
BEGIN
    ...
    -- Update donor profile timestamp
    UPDATE public.organ_donor_profiles
    SET updated_at = NOW()
    WHERE id = v_donor_id;

    -- Insert new immutable consent history record (UPDATE action)
    INSERT INTO public.organ_donation_consents (
        donor_profile_id,
        patient_id,
        consent_version,
...
BEGIN
    ...
    -- Create immutable consent history row with REVOKE action
    INSERT INTO public.organ_donation_consents (
        donor_profile_id,
        patient_id,
        consent_version,
...
BEGIN
    ...
    IF v_donor_id IS NULL THEN
        -- If profile doesn't exist, call register
    ...
    -- Insert new immutable consent history row with REGISTER action
    INSERT INTO public.organ_donation_consents (
        donor_profile_id,
        patient_id,
        consent_version,
