...
BEGIN
  ...
  -- 3. Check active approved consent with category
...
BEGIN
  ...
  -- 3. Determine record types and duration
  ...
  -- 5. Insert approved consent record
  ...
  -- 7. Doctor Notification: ACCESS_GRANTED
  INSERT INTO public.notifications (
    user_id, type, title, message, patient_id, related_request_id
  ) VALUES (
...
-- Function: Patient Revokes Consent
